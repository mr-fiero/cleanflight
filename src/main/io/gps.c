...
static const uint8_t ubloxInit[] = {
    ...
    //My Mods - Mr-Fiero
    0xB5, 0x62, 0x06, 0x08, 0x06, 0x00, 0xC8, 0x00, 0x01, 0x00, 0x01, 0x00, 0x8E, 0x8A,                          // set rate to 8Hz - Ublox 7 and up
    //0xB5, 0x62, 0x06, 0x08, 0x06, 0x00, 0xA8, 0x00, 0x01, 0x00, 0x01, 0x00, 0xBE, 0xAA,                        // set rate to 5.95Hz - Ublox 6 engines MAX NAV rate
    //0xB5, 0x62, 0x06, 0x08, 0x06, 0x00, 0xA8, 0x00, 0x01, 0x00, 0x01, 0x00, 0x7A, 0x12,                        // set rate to 10Hz    
    0x00, 0x03, 0x02, 0x03, 0x10, 0x0A, 0x00, 0x00, 0x01, 0x00, 0x00, 0x43, 0x06,                                    // Disable Assistnow
    //0xB5, 0x62, 0x06, 0x16, 0x08, 0x00, 0x02, 0x07, 0x03, 0x00, 0x51, 0x08, 0x00, 0x00, 0x89, 0x39,     // disable SBAS - jumps if updated in flight
    
    0xB5, 0x62, 0x06, 0x24, 0x24, 0x00, 0xFF, 0xFF, 0x03, 0x03, 0x00, 0x00,                                               // Navigation 5 Settings
    0x00, 0x00, 0x10, 0x27, 0x00, 0x00, 0x05, 0x00, 0x96, 0x00, 0x96, 0x00,
    0x50, 0x00, 0xC8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xD2, 0x57,
    
    0xB5, 0x62, 0x06, 0x23, 0x28, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0x03, 0x00, 0x00,        // Navigation Expert 5
    0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x00, 0x00, 0x00, 0x64, 0x96, 0x00, 0x00,       // SV angle is only 5  0xD3 0x6F last two for 6 degrees
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xBA, 0x1A,                                              // This is using the Pedestrian dynamic model

    0xB5, 0x62, 0x06, 0x00, 0x14, 0x00, 0x01, 0x00, 0x00, 0x00, 0xD0, 0x08, 0x00,
    0x00, 0x00, 0xC2, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,       // Port settings
    0xB8, 0x42,

    0xB5, 0x62, 0x06, 0x13, 0x04, 0x00, 0x1B, 0x00, 0x8B, 0xA9, 0x6C, 0xF8,                 // Ant Settings - need to make sure active antenna's are powered!
    
    0xB5, 0x62, 0x06, 0x11, 0x02, 0x00, 0x00, 0x00, 0x19, 0x81,                                    // set Max performance mode

    //0xB5, 0x62, 0x06, 0x09, 0x0D, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF,                        //  I think this would save config to eeprom...needs testing
    //0xFF, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x07, 0x9F, 0xA2,                       

    0xB5, 0x62, 0x06, 0x04, 0x04, 0x00, 0x00, 0x00, 0x09, 0x00, 0x17, 0x76,               // Hotstart GPS - All done, restarting GPS
    //0xB5, 0x62, 0x06, 0x04, 00x4, 0x00, 0x00, 0x00, 0x02, 0x00, 10x0, 0x68,             // I show this one for hotstart...need to
};
